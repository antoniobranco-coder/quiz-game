...
const questoes: QuestaoType[] = [
    {
        id: 306,
        questao: 'Qual bicho transmite a Doença de Chagas?',
        opcoesRespostas: [
            { resposta: 'Abelha', certa: false },
            { resposta: 'Barata', certa: false },
            { resposta: 'Pulga', certa: false },
            { resposta: 'Barbeiro', certa: true }
        ]
    },
    {
        id: 202,
        ...
        opcoesRespostas: [
            { resposta: 'Caju', certa: false },
            { resposta: 'Côco', certa: false },
            { resposta: 'Chuchu', certa: false },
            { resposta: 'Abóbora', certa: true }
        ]
    },
    {
        id: 203,
        ...
        opcoesRespostas: [
            { resposta: 'Manada', certa: false },
            { resposta: 'Alcateia', certa: false },
            { resposta: 'Rebanho', certa: false },
            { resposta: 'Matilha', certa: true }
        ]
    },
    {
        id: 204,
        ...
        opcoesRespostas: [
            { resposta: 'Equilátero', certa: false },
            { resposta: 'Isóceles', certa: false },
            { resposta: 'Trapézio', certa: false },
            { resposta: 'Escaleno', certa: true }
        ]
    },
